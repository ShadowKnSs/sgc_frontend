...
const PlanAccion = ({ idProceso, anio }) => {
  ...
  if (!planCorrectivo) {
    return <Typography color="text.secondary">No hay datos del plan correctivo.</Typography>;
  }
  ...
  return (
    <Box sx={{ mt: 5, margin: 7 }}>
      ...
      <Typography variant="h6" sx={{ mt: 2 }}>Origen de la no conformidad:</Typography>
      <Typography>{planCorrectivo.origenConformidad}</Typography>

      <Typography variant="h6" sx={{ mt: 2 }}>Equipo de mejora:</Typography>
      <Typography>{planCorrectivo.equipoMejora}</Typography>
    
    {/* Actividades */}
    <Typography variant="h6" sx={{ mt: 2 }}>Actividades de reaccion:</Typography>
      <TableContainer component={Paper} sx={{ mb: 2 }}>
        <Table size="small">
          <TableHead>
            <TableRow>
      ...
      <Typography variant="h6" sx={{ mt: 2 }}>Revision y analisis:</Typography>
      <Typography>{planCorrectivo.revisionAnalisis}</Typography>

      <Typography variant="h6" sx={{ mt: 2 }}>Causa Raiz:</Typography>
