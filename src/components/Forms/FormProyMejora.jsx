      ...
      case 0:
        return (
          <Box>
            ...
            <TextField fullWidth label="Número de Mejora" name="noMejora" type="number" value={formData.noMejora} onChange={handleChange} margin="normal" disabled={disabled} inputProps={{ min: 0 }} error={getError("noMejora")} helperText={getHelper("noMejora")} />
