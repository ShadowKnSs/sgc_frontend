...
import {
  ...
  Paper, TableContainer, IconButton, Box, Tooltip, TablePagination
} from "@mui/material";
          ...
          <TableBody>
            {registrosPaginados.map((record, index) => (
              ...
              >
                ...
                <TableCell>
                  <Tooltip title={record.elementoEntrada}>
                    <span style={ELLIPSIS_STYLE}>{record.elementoEntrada}</span>
                  </Tooltip>
                </TableCell>

                <TableCell>
                  <Tooltip title={record.descripcion}>
                    <span style={ELLIPSIS_STYLE}>{record.descripcion}</span>
                  </Tooltip>
                </TableCell>

                <TableCell>
                  <Tooltip title={record.entregable}>
                    <span style={ELLIPSIS_STYLE}>{record.entregable}</span>
                  </Tooltip>
                </TableCell>
